...
public final class Utilitario {
	...
	public static void caputarPantallarError(String rutaCarpeta, String mensajeError, WebDriver webDriver) {
		try {
			...
			// hora, minuto, segundo y milisegundos el simpledateformat es para poner el formato q deseamos
			...
			// Creamos un archivo txt con el mensaje de error en vez de\\ es recomendable usar el File.separator por
			//que este reconoce cualquier sistema operativo
